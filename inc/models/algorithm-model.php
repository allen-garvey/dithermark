...
function bwAlgorithmModelBase(): array{
    return [
        ...
        new DitherAlgorithm('Hatch 4×4', 'OrderedDither.createHatch(4)', 'BwDither.createHatchOrderedDither(4)'),
...
function colorAlgorithmModelBase(): array{
    return [
        ...
        new DitherAlgorithm('Hatch 4×4', 'OrderedDither.createColorHatch(4)', 'ColorDither.createHatchOrderedDither(4)'),

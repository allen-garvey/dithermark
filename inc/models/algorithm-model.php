...
function bwAlgorithmModelBase(): array{
    return [
        ...
        new DitherAlgorithm('Zigzag Horizontal', 'OrderedDither.createZigZagDither(8)', 'BwDither.createZigZagDither(8)'),
        new DitherAlgorithm('Zigzag Vertical', 'OrderedDither.createZigZagVerticalDither(8)', 'BwDither.createZigZagVerticalDither(8)'),
        'Ordered (Pattern)',
...
function colorAlgorithmModelBase(): array{
    return [
        ...
        new DitherAlgorithm('Zigzag Horizontal', 'OrderedDither.createZigZagColorDither(8)', 'ColorDither.createZigZagColorDither(8)'),
        new DitherAlgorithm('Zigzag Vertical', 'OrderedDither.createZigZagVerticalColorDither(8)', 'ColorDither.createZigZagVerticalColorDither(8)'),
        'Ordered (Pattern)',

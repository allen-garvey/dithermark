...
function colorAlgorithmModelBase(): array{
    return [
        ...
        new DitherAlgorithm('Yliluoma 1 8×8', 'OrderedDither.createYliluoma2ColorDither(8, "bayer")', 'ColorDither.createYliluoma1OrderedDither(8, "bayer")'),
        new DitherAlgorithm('Yliluoma 1 16×16', 'OrderedDither.createYliluoma2ColorDither(16, "bayer")', 'ColorDither.createYliluoma1OrderedDither(16, "bayer")'),
        new DitherAlgorithm('Yliluoma 1 (Crosshatch Right)', 'OrderedDither.createYliluoma2ColorDither(4, "crossHatchRight")', 'ColorDither.createYliluoma1OrderedDither(4, "crossHatchRight")'),

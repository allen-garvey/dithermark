...
function bwAlgorithmModelBase(): array{
    return [
        ...
        new DitherAlgorithm('Cluster 4×4', 'OrderedDither.createClusterDither(4)', 'BwDither.createClusterDither(4)'),
        new DitherAlgorithm('Hatch 4×4', 'OrderedDither.createHatchRightDither(4)', 'BwDither.createHatchRightDither(4)'),
        new DitherAlgorithm('Fishnet 8×8', 'OrderedDither.createFishnetDither(8)', 'BwDither.createFishnetDither(8)'),
...
function colorAlgorithmModelBase(): array{
    return [
        ...
        new DitherAlgorithm('Cluster 4×4', 'OrderedDither.createClusterColorDither(4)', 'ColorDither.createClusterColorDither(4)'),
        new DitherAlgorithm('Hatch Right', 'OrderedDither.createHatchRightColorDither(4)', 'ColorDither.createHatchRightColorDither(4)'),
        new DitherAlgorithm('Fishnet 8×8', 'OrderedDither.createFishnetColorDither(8)', 'ColorDither.createFishnetColorDither(8)'),

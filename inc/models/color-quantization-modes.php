...
function colorQuantizationModesBase(): array{
    return [
        ...
        'ChannelsQ',
        new ColorQuantizationMode('ChannelsQ (Balanced)', 'ColorChannel.colorChannel', ['greyMix' => 4]),
        new ColorQuantizationMode('ChannelsQ (Vibrant)', 'ColorChannel.colorChannel', ['greyMix' => 32]),
        new ColorQuantizationMode('ChannelsQ (Wide)', 'ColorChannel.colorChannel', ['greyMix' => 1]),
        'Artiquant 3',

...
function colorQuantizationModesBase(): array{
    return [
        ...
        'Octree',
        new ColorQuantizationMode('OCTREE_1', 'Octree (Majority 1)', 'octree', ['sort' => 0]),
        new ColorQuantizationMode('OCTREE_2', 'Octree (Majority 2)', 'octree', ['sort' => 1]),
        new ColorQuantizationMode('OCTREE_3', 'Octree (Minority 1)', 'octree', ['sort' => 2]),
        new ColorQuantizationMode('OCTREE_4', 'Octree (Minority 2)', 'octree', ['sort' => 3]),
        'Median Cut',

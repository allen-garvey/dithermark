...
function colorQuantizationModesBase(): array{
    return [
        ...
        'Color Channel',
        new ColorQuantizationMode('Color channel (Balanced)', 'ColorChannel.colorChannel', ['greyMix' => 16]),
        new ColorQuantizationMode('Color channel (Narrow)', 'ColorChannel.colorChannel', ['greyMix' => 64]),
        new ColorQuantizationMode('Color channel (Wide)', 'ColorChannel.colorChannel', ['greyMix' => 8]),
        'Artiquant 3',

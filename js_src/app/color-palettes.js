App.ColorPalettes = (function(){
    ...
    function getPalettes(){
        return [
            ...
            {title: 'Elements', colors: ['#201A0B', '#fcfae2', '#492910', '#a9220f', '#2b347c', '#F4B38A', '#fce76e', '#2b7409', '#080000', '#6a94ab', '#d0ca40', '#234309']},
            ...
            {title: 'Sepia', colors: ['#301A1A', '#D9CBC0', '#683737', '#B39076', '#3F0C03', '#1D1919', '#64543C', '#9E8C72', '#F3EBE3', '#7D3A0E', '#59332C', '#F0C592']},
            ...
            {title: 'Apricot', colors: ['#18191b', '#30376d', '#daf9fe', '#d6860c', '#6089d6', '#2d2752', '#eee07d', '#99dbd6', '#d9d519', '#558d79', '#baa06d', '#1768ce']},
            {title: 'Patina', colors: ['#946146', '#5edfe5', '#427c88', '#98744a', '#ce6f41', '#41363c', '#ffebca', '#1a3236', '#d68760', '#803942', '#ebbf8e', '#0bb0c6']},

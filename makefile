...
JS_SRC=$(JS_SRC_DIR)/fs.js $(JS_SRC_DIR)/timer.js $(JS_SRC_DIR)/pixel.js $(JS_SRC_DIR)/canvas.js $(JS_SRC_DIR)/histogram.js $(JS_SRC_DIR)/app.js
JS_OUTPUT=$(JS_OUTPUT_DIR)/app.js


DITHER_WORKER_DIR=$(JS_SRC_DIR)/image_dithering_worker

DITHER_WORKER_SRC=$(JS_SRC_DIR)/timer.js $(JS_SRC_DIR)/pixel.js $(DITHER_WORKER_DIR)/image.js $(DITHER_WORKER_DIR)/threshold.js $(DITHER_WORKER_DIR)/error-prop-dither.js $(DITHER_WORKER_DIR)/ordered-dither.js $(DITHER_WORKER_DIR)/main.js

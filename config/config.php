<?php
    ...
    */
    ...
    define('TEMPLATES_VUE_COMPONENTS_PATH', TEMPLATES_PATH.DIRECTORY_SEPARATOR.'vue_components'.DIRECTORY_SEPARATOR);
    define('TEMPLATES_WEBGL_SHADERS_PATH', TEMPLATES_PATH.DIRECTORY_SEPARATOR.'webgl_shaders'.DIRECTORY_SEPARATOR);

...
/**
 *
 * @param {number} minimumColorsLength
 * @returns {Palette[]}
 */
const getPalettes = minimumColorsLength =>
    padPaletteColorsToMinimumLength(defaultPalettes(), minimumColorsLength);
 ...
 * @returns {Palette[]}
 */
const padPaletteColorsToMinimumLength = (palettes, minimumColorsLength) =>
 ...
 *
 * @param {string[]} colors
 * @param {string} savedPaletteId
 * @returns {Palette}
 */
const generateUserSavedPalette = (colors, savedPaletteId) => ({
    title: `Saved Palette ${savedPaletteId}`,
    colors: colors,
    isSaved: true,
});

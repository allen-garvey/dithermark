...
export default {
    ...
    unsharpMaskValues: [
        { strength: 0, radius: 0 },
        { strength: 3.0, radius: 1 },
        { strength: 5.0, radius: 1 },
        { strength: 2.0, radius: 2 },
        { strength: 5.0, radius: 2 },
        { strength: 3.0, radius: 3 },
        { strength: 5.0, radius: 3 },
        { strength: 2.0, radius: 4 },
        { strength: 3.0, radius: 4 },
        { strength: 5.0, radius: 4 },
        { strength: 1.5, radius: 5 },
        { strength: 3.0, radius: 5 },
        { strength: 5.0, radius: 5 },
    ],

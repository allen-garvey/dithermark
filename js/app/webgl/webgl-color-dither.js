...
colorDitherModeTranslation.set(ColorDitherModes.get('RED').id, {
    distanceFunc: 'webgl-red-distance',
});
colorDitherModeTranslation.set(ColorDitherModes.get('GREEN').id, {
    distanceFunc: 'webgl-green-distance',
});

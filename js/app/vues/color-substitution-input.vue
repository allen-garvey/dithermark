    ...
    <fieldset>
        ...
        <div :class="$style.colorReplaceContainer">
            <color-input
                label="Black"
                :is-selected="
                    shouldShowColorPicker && colorPickerColorIndex === 0
                "
            ...
            <color-input
                label="White"
                :is-selected="
                    shouldShowColorPicker && colorPickerColorIndex === 1
                "
...
export default {
    ...
    computed: {
        ...
        areColorReplaceColorsChangedFromDefaults() {
            return !ColorPicker.areColorArraysIdentical(
                ColorPicker.defaultBwColors(),
                this.colorReplaceColors
            );
        },
    },
    methods: {
        ...
        colorPickerOk(selectedColorHex) {
            ...
            if (
                this.colorReplaceColors[this.colorPickerColorIndex] !==
                selectedColorHex
            ) {
